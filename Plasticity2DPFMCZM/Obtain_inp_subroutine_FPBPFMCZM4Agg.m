...
%      EE/1.2,nu,EY/1.2,EH/1.2,crieps,thick,rho,ANISOSWT,PLASWT,1.2*Lc,Gc/1.2,ELSSWT,DRSWT;
%      210000,nu,210000,210000,crieps,thick,rho,ANISOSWT,PLASWT,Lc/10,10*Gc,1,DRSWT;];
% with agg
mat=[EE,nu,EY,EH,crieps,thick,rho,ANISOSWT,PLASWT,Lc,Gc,ELSSWT,DRSWT;
     3*EE,nu,3*EY,3*EH,crieps,thick,rho,ANISOSWT,PLASWT,Lc/5,5*Gc,1,DRSWT;
     EE/2,nu,EY/2,EH/2,crieps,thick,rho,ANISOSWT,PLASWT,2*Lc,Gc/2,ELSSWT,DRSWT;
     210000,nu,210000,210000,crieps,thick,rho,ANISOSWT,PLASWT,Lc/10,10*Gc,1,DRSWT;];
