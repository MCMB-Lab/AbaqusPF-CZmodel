...
lc=0.05;% length scale, [mm]
gc=0.05;% critical energy release rate, [N/mm]
elswt=0;% ELSSWT=0: without linear elastic range; ELSSWT=1: with linear elastic range
drswt=0;% DRSWT=0: normal damage simulation; DRSWT=1: simulation consider initial damage
mat=[15000,nu,Ystress,Hmod,epscr,density,anisoswt,plswt,lc,gc,elswt,drswt;];
%% generate inp file and subroutine
% Abaqus2PhasefieldUEL3DPlasticity('Job-1.inp',mat)
Zbaqus2PhasefieldUEL3DPlasticity('Zob-1.inp',mat)
